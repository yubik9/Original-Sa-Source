...
int mainsockfd;             /* accept 及鎔域婁醒卞中木月 */
struct sockaddr_in localaddr;       /* bind 允月失玉伊旦 */
    

struct connection *con;        /* 戊生弁扑亦件т昫 */
...
#define OK     0        /* 嶽跦 */
#define TCPSTRUCT_ENOMEM -1       /* malloc 撩л */
#define TCPSTRUCT_ESOCK -2        /* socket 撩л */
#define TCPSTRUCT_EBIND -3        /* bind 撩л */
#define TCPSTRUCT_ELISTEN -4      /* listen 撩л */
...
#define TCPSTRUCT_EHOST -9        /* gethostbyname 撩л */
#define TCPSTRUCT_ECONNECT -10    /* connect 撩л */
...
/*
  伕弘及伕□氾□玄市它件玄毛ぜ月﹝
  云卅元凜渝及手及反允屯化及伕弘白央奶伙互云卅元卞卅月方丹卞允月﹝

  仇及酷迋反醒儂及瑕互云云仁卅月互﹜籣醱匹奶件正□田伙毛庍凳仄化手
  釐暹屺分﹝
...
/*
  づ心仇戈手及互手丹卅仁化﹜仄井手 remoteclose 分勻凶日 -1 毛井尹允
...
/*
  1墊毛方心仇戈﹝
  int kend : 1卅日墊坱及 \n 毛誚允
  int kend_r : 1卅日墊坱及 \r 手誚允(丐木壬)

  づ心仇戈手及互手丹卅仁化﹜井勾 remote closed 分勻凶日-1毛井尹允
  // Nuke
	Read 1 line
...
/*
  ...
  mbsize 井日mbuse 毛婁中化扔奶朮毛井仃月分仃﹝
  仇引井中芴曰及坌反拑骰允月﹝公氏卅稱井中襖卞仇分歹日卅仁化手第﹝
