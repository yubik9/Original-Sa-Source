...
/*
  DB及云云五今互凶日氏仁卅勻凶日歹曰丐化卅云允﹝中引及扔奶朮及2у卞允月
  0分勻凶日1卞允月
 */
static int
reallocDB( void )
...
dbAllocNode()
{
    ...
    for(i=0;i<dbsize;i++){
        ...
        if( master_buf[dbent_finder].use == 0 ){
            ...
            /* Spock deleted 2000/10/12
            // int 匹手尥笛樹扷及啃卞stringbuffer毛儅勾儀卞允月 kawata
...
/*
  伉件弁及玄永皿毛芨尹日木凶日﹜襖毛俇曰卞用□玉毛腹綢仄化
  贗濠卅午仇欠卞 Insert 允月﹝切中今中杅井日云云五中杅卞卅日氏匹中月午
  移爛
...
/*
  犯□正矛□旦及抩蟆毛ぜ月﹝db反醒互劑卅中及匹忔騷卞strcmp仄化方中
  DBTYPE :潘挀﹝

  云卅元卅引尹及刓反﹜幫醒午妐儂昫及徆杅卞繡箕允月仇午互匹五月﹝
    ...
    for(i=0;i<MAXTABLE;i++){
        if( dbt[i].use == 0 ){
            ...
            */
            ...
            /* 玄永皿及用□玉毛賡渝祭允月卅曰﹝
             妐儂昫及樺寧手幫醒及樺寧手云卅元匹方中﹝
             0x7fffffff午中丹襖反﹜妐儂昫及樺寧反今幻升啦怗毛手凶卅中及分﹝*/
...
/*
  ...
  腹綢仄化葦勾仃凶用□玉卞覆仄化﹜
  伉件弁井日�握迨�勻化井日﹜漆蘸反末□玄允月及卞銀丹襖毛凶方曰卞
...
#define MAXHITS 1024        /* 贗癲支卅丐﹝匹手仇木匹蝸坌日仄中冗 ringo */
    struct hitent{          /* 仇及厭瞻蟲卞甲永玄仄凶支勾毛凶戶化中仁 */
        int entind;
        int rank;
    };
...
/* 隙爛仄凶匏譆井日隙爛仄凶蜊醒潸曰分允﹝
 撩л仄凶日扙﹜嶽跦仄凶日0﹝嶽跦仄化手塢及請恘及午五互丐月冗﹝
 拺“num互0及午五午井﹜竟癲允月巨件玄伉互卅中午五﹝
