...
typedef enum
{
    CHAR_WALKSUCCESSED,     /* 嶽跦    */
    CHAR_WALKSYSTEMERROR,   /* 扑旦氾丞巨仿□т昫及index民尼永弁卞
                             * 夫勻井井勻凶午井 */
    CHAR_WALKEXTEND,        /*  �炾洏炕憧苤慾楔て滮酗忖�仄凶﹝NPC卞及心*/
    CHAR_WALKHITOBJECT,     /*  窒井坁卞癲勻化﹜忷仃卅井勻凶    */
    CHAR_WALKPREWALK,       /*  prewalk奶矛件玄匹忷仃卅井勻凶( 檗祭 ) */
    CHAR_WALKDIE,           /*  韶氏匹中化忷仃卅中  */
    CHAR_WALK1357,          /*  標戶杅輊卞忷仇丹午仄化忷仃卅井勻凶  */
}CHAR_WALKRET;
...
typedef enum
{
    CHAR_WINDOWTYPE_RETURNTOELDER=-1,   /*  贏牁尺枑月它奴件玉它    */
    CHAR_WINDOWTYPE_RESURRECTION=-2,   /*  汊唾允月它奴件玉它    */

	CHAR_WINDOWTYPE_SELECTBATTLE = 1,		/* ェ月爵お毛薊鎗允月它奴件玉它 */
	CHAR_WINDOWTYPE_SELECTDUEL = 2,  		/* ェ月DUEL毛薊鎗允月它奴件玉它 */
	CHAR_WINDOWTYPE_SELECTTRADECARD = 3, 	/* 抩銅跟晶毛薊鎗允月它奴件玉它 */
	CHAR_WINDOWTYPE_SELECTPARTY = 4, 		/* 由□氾奴毛薊鎗允月它奴件玉它 */
	CHAR_WINDOWTYPE_SELECTBATTLEWATCH = 5, 	/* 棋爵毛薊鎗允月它奴件玉它 */
	CHAR_WINDOWTYPE_MICMESSAGE = 6,			/* MICNPC毛銀勻化請月它奴件玉它 */

	// CoolFish: Trade 2001/4/18
	CHAR_WINDOWTYPE_SELECTTRADE = 7,	/* 交易 Window */

	CHAR_WINDOWTYPE_SELECTRENAMEITEM_PAGE1 = 10,	/* 抩蟆毛庍凳允月失奶氾丞毛薊鎗允月它奴件玉它 */
	CHAR_WINDOWTYPE_SELECTRENAMEITEM_PAGE2 = 11,	/* 抩蟆毛庍凳允月失奶氾丞毛薊鎗允月它奴件玉它 */
	CHAR_WINDOWTYPE_SELECTRENAMEITEM_PAGE3 = 12,	/* 抩蟆毛庍凳允月失奶氾丞毛薊鎗允月它奴件玉它 */
	CHAR_WINDOWTYPE_SELECTRENAMEITEM_PAGE4 = 13,	/* 抩蟆毛庍凳允月失奶氾丞毛薊鎗允月它奴件玉它 */
	CHAR_WINDOWTYPE_SELECTRENAMEITEM_RENAME = 14,	/* 抩蟆毛ェ恘允月它奴件玉它 */
	CHAR_WINDOWTYPE_SELECTRENAMEITEM_RENAME_ATTENTION  = 15,	/* 抩蟆毛ェ恘允月它奴件玉它 */
...
EXTERN int EnemyMoveNum;	/* き凜卞瘉嫖が仃月襯及醒 */
