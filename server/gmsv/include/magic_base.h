...
typedef enum
{
	...
	MAGIC_TARGET_ALLMYSIDE,		/* 怗杅蟈蟲 */
	MAGIC_TARGET_ALLOTHERSIDE,	/* 鍬澎礎蟈蟲 */
	MAGIC_TARGET_ALL,			/* 蟈化 */
	MAGIC_TARGET_NONE,			/* 簿手薊鎗請侳卅中﹝侂豢支凶戶及凜 */
	MAGIC_TARGET_OTHERWITHOUTMYSELF,/* 職及諦﹋憤坌殖引卅中) */
	MAGIC_TARGET_WITHOUTMYSELFANDPET,  /* 憤坌午矢永玄動陸 */
	MAGIC_TARGET_WHOLEOTHERSIDE,/* 弅杅及扔奶玉蟈蟲 */
