...
typedef enum {
    CHAR_MODAI    			= CHAR_CHARM,    		/*  矢永玄咍及及鏑擦艘膜懇襖    */
	CHAR_VARIABLEAI 		= CHAR_LUCK,			/*  矢永玄及鏑擦艘庍祭襖﹋ㄠㄟㄟу仄凶襖匹儅勻化云仁﹌ */
    CHAR_SLOT 				= CHAR_DEFAULTPET,		/* 檗�蚺禰誑疇�請侳月旦伕永玄醒﹋矢永玄互銀迕﹌*/
   	CHAR_PETGETLV			= CHAR_CHATVOLUME,		/* 必永玄今木凶伊矛伙﹋矢永玄及心銀迕 ﹌*/
    CHAR_PUTPETTIME			= CHAR_LOGINCOUNT,		/*  矢永玄互譁昍卞譆井木凶凜棉 */
	...
	CHAR_PETMAILFROMFLOOR	= CHAR_DUELBATTLECOUNT,	/* 丟□伙毛霜勻凶凜及白伕失 */
	CHAR_PETMAILFROMX		= CHAR_DUELWINCOUNT,	/* 丟□伙毛霜勻凶凜及�媞薺� */
	CHAR_PETMAILFROMY		= CHAR_DUELLOSECOUNT,	/* 丟□伙毛霜勻凶凜及�棳薺� */
	CHAR_PETMAILEFFECT		= CHAR_DUELSTWINCOUNT,	/* 矢永玄丟□伙及請蜇及巨白尼弁玄�砦� */
	CHAR_PETSENDMAILCOUNT	= CHAR_TALKCOUNT,		/* 矢永玄互丟□伙毛捫氏分莢醒 */
    CHAR_PETRANK			= CHAR_LASTTIMESETLUCK, /* 矢永玄及仿件弁(矢永玄迕﹌ㄠ℅ㄥ﹝ㄟ反巨仿□迕 */
	CHAR_PETID				= CHAR_DUELMAXSTWINCOUNT,/* 矢永玄及氾件皿伊□玄及�氿� */
