...
/*
 * ¥í¥°¥¤¥ó¤·¤Æ¤¤¤Ê¤¤¡¢ ¥í¥°¥¤¥ó¤·¤Æ¤¤¤ë¡¢ ¥í¥°¥¤¥óÃæ ¥­¥ã¥éºî¤êÃæ
 * ¥í¥°¥¢¥¦¥ÈÃæ( ¥»¡¼¥ÖÃæ ) , ¥í¥°¥¢¥¦¥ÈÃæ( ¥¢¥ó¥í¥Ã¥¯Ãæ )
 *  N ¤Ï NOT ¡¢ W ¤Ï WHILE , UL ¤Ï UNLOCK ¤Î»ö
 */
typedef enum
{
    NOTLOGIN,           /*  ¥í¥°¥¤¥ó¤·¤Æ¤¤¤Ê¤¤  */
    LOGIN,              /*  ¥í¥°¥¤¥óÃæ          */
    WHILELOGIN,         /*  ¥í¥°¥¤¥ó¤·¤Æ¤¤¤ëÅÓÃæ*/
    WHILECREATE,        /*  ºî¤Ã¤Æ¤¤¤ëÅÓÃæ      */
    WHILELOGOUTSAVE,    /*  ¥í¥°¥¢¥¦¥È¤Î¥»¡¼¥ÖÅÓÃæ  */
    WHILECANNOTLOGIN,   /*  ¥í¥°¥¤¥ó¤Ç¤­¤Ê¤«¤Ã¤¿»þ¤Î¥¢¥ó¥í¥Ã¥¯½èÍýÃæ    */
    WHILECHARDELETE,    /*  ¥­¥ã¥éºï½üÃæ    */
    WHILEDOWNLOADCHARLIST,  /*  ¥­¥ã¥é¥ê¥¹¥È¥À¥¦¥ó¥í¡¼¥ÉÃæ  */
    WHILECHANGEPASSWD,  /*  ¥Ñ¥¹¥ï¡¼¥ÉÊÑ¹¹Ãæ    */

    WHILELOSTCHARSAVE,  /*  ¥í¥¹¥È¤Ç¥­¥ã¥é¥»¡¼¥Ö¤·Ãæ    */
    WHILELOSTCHARDELETE,/*  ¥í¥¹¥È¤Ç¥­¥ã¥é¾Ã¤·Ãæ    */

    WHILECLOSEALLSOCKETSSAVE, /* closeallsockets ¤Ç¥­¥ã¥é¥»¡¼¥Ö¤·Ãæ*/
    WHILESAVEWAIT,              /* ¥í¥°¥¢¥¦¥È¤Î¥»¡¼¥Ö¤Ë¹Ô¤¯Á°¤Î½çÈÖÂÔ¤ÁÃæ*/
}LoginType;

/* È½ÊÌ¤·¤Æ¤¤¤Ê¤¤¡¢¥¢¥«¥¦¥ó¥È¥µ¡¼¥Ð¡¢¥¯¥é¥¤¥¢¥ó¥È¡¢¥¢¥É¥à */
typedef enum
{
...
#define CDKEYLEN    16
#define PASSWDLEN   16
/* ¤³¤ì¤ÎÊÑ¹¹¤ÏÉÔ²Ä(¤¹¤ë¤Ê¤é Char ¤ÎSTRING64 ¤âÅ¬ÀÚ¤ÊÃÍ¤ËÀÚ¤ê´¹¤ë¤³¤È*/
#define CHARNAMELEN     32

#define CLITIMEOUT_SEC  120     /* ¥¯¥é¥¤¥¢¥ó¥È¤«¤éread¤·¤Ê¤«¤Ã¤¿¤é¡¢
                                   ¤³¤Î»þ´Ö¤Ç¥¿¥¤¥à¥¢¥¦¥È¡¢¥í¥°¥¢¥¦¥È¡£ */

#define		NET_STRING_SUCCESSFULL	"successful"
#define		NET_STRING_FAILED		"failed"

// ¤Õ¤Ä¤¦¤Î£Æ£Ä¤Î¥ê¡¼¥É¡¤¥é¥¤¥È¥Ð¥Ã¥Õ¥¡¥µ¥¤¥º
#define RBSIZE 65536
...
EXTERN int      bindedfd;     /*¥í¡¼¥«¥ë¥¢¥É¥ì¥¹¤Ë¥Ð¥¤¥ó¥É¤·¤¿¥½¥±¥Ã¥È*/
