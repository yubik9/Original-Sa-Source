...
#define PETSKILL_ID_RENZOKU		1	// Ï¢Â³¹¶·â
#define PETSKILL_ID_GUARDIAN	2	// Ãé¸¤¥Ï¥Á¸ø
#define PETSKILL_ID_CHARGE		3	// ¥Á¥ã¡¼¥¸¹¶·â
#define PETSKILL_ID_ICHIGEKI	100	// °ì·âÉ¬»¦
#define PETSKILL_ID_POWERBALANCE 110	// ÇØ¿å¤Î¿Ø

//**********************************************************************
//
//  ÀÐÈÇ-- Â¾¿Í¤ò¼é¤ê¤Ê¤¬¤é¹¶·â
//
...
//*******************************************************
// ÀÐÈÇ-- ÃÏµå°ì½µ(±£¤ì¤Æ£±¥¿¡¼¥ó¸å¤ËÁê¼ê¤ÎÇØ¸å¤«¤é¹¶·â)
//
