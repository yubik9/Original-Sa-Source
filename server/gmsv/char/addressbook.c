 ...
 * MSG皿伕玄戊伙井日勾井歹木月﹝
 *
 * 支月仇午反﹜connection井日cdkey匹腹綢仄化﹜平乓仿抩手
 * 甲永玄仄凶日﹜ MSG_send允月﹝公及午五卞﹜憤坌及樹扷互
...
BOOL ADDRESSBOOK_sendMessage( int cindex, int aindex, char* text , int color )
{
	...
	for( i = 0 ; i < playernum ; i ++){
		...
		{
			/*
			 * CDKEY 手 平乓仿抩手域譙仄凶﹝公及平乓仿弁正及
			 * 失玉伊旦皮永弁卞憤坌及樹扷互丐月井譬屯化﹜
			 * 繡箕仄凶日﹜MSG允月﹝
			 */
...
/*------------------------------------------------------------
 * 夫午勾及失玉伊旦皮永弁巨件玄伉毛﹜妐儂昫卞卅云允﹝
 * 仇木反平乓仿忡繡迕卅及匹弁仿奶失件玄卞霜耨允月方曰手懇割
 * 卅手及匹丐月优邰互丐月﹝
 * 婁醒
 *  a   ADDRESSBOOK_entry*  妐儂昫卞仄凶中厭瞻蟲尺及禾奶件正
 * 忒曰襖
 *  char *
 ------------------------------------------------------------*/
...
/*------------------------------------------------------------
 * 妐儂昫祭今木化中月失玉伊旦皮永弁巨件玄伉毛﹜厭瞻蟲卞卅云允﹝
 * 仇及瑛絆厭瞻蟲及use動陸及樹扷反敦僬卞卅月﹝
 * 婁醒
 *  in      char*                   妐儂昫
