								...
								int fx, int fy )
{
    ...
    if( ABS(vx) >= seesiz/2 ||       /*  º¹¤¬Âç¤­¤¤  */
        ABS(vy) >= seesiz/2 ){       /*  º¹¤¬Âç¤­¤¤  */
        return;
        ...
        int absy = ABS(vy);
        /*
         * ¤Ò¤È¤ÄÂ¿¤á¤Ë¥¹¥¿¡¼¥È¤ò¼è¤ë¤Î¤È¡¢vx , vy ¤«¤é1¤Ò¤¯¤Î¤¬¥Ý¥¤¥ó¥È
         * Á°¤È¤«¤µ¤Ê¤é¤Ê¤¤¤è¤¦¤Ë¡¢
...
void CHAR_walkcall( int index )
{
	...
	/* ¿Æ¤Ê¤é»öÁ°¤Ë¾ì½ê¤òµ­²±¤·¤Æ¤ª¤¯
	 * ¿Æ¤ÎÆ°¤¯Á°¤Î¾ì½ê¤òÌÜÉ¸¤Ë»Ò¤¬°ÜÆ°¤¹¤ë°Ù
	 */
    ...
    /* 99/03/09 By Kawata */
    /* walk¤Î·ë²Ì¡¢WALKARRAY¤¬¥¯¥ê¥¢¤µ¤ì¤Æ¤¤¤ë¾ì¹ç¤¬¤¢¤ë¤Î¤Ç
     * ¼è¤êÄ¾¤·¤Æ¥³¥Ô¤ë
     */
    strcpysafe( tmp ,sizeof(tmp),
                CHAR_getWorkChar(index,CHAR_WORKWALKARRAY));
...
static void CHAR_sendCDCharaAtWalk( int charaindex, int of, int ox, int oy,	 int xflg, int yflg ){
	...
	if( of !=  fl ||  /*  ¥Õ¥í¥¢¤¬°ã¤¦    */
		ABS(x - ox) > seesiz/2 ||       /*  º¹¤¬Âç¤­¤¤  */
		ABS(y - oy) > seesiz/2 )        /*  º¹¤¬Âç¤­¤¤  */
		return;
