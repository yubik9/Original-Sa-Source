...
typedef struct tagENCOUNT_Table
{
    int                 index;
    int                 floor;
    int                 encountprob_min;                /* ¥¨¥ó¥«¥¦¥ó¥È³ÎÎ¨ */
    int                 encountprob_max;                /* ¥¨¥ó¥«¥¦¥ó¥È³ÎÎ¨ */
    int                 enemymaxnum;        /* ¤É¤ì¤À¤±Å¨¤òºî¤ë¤« */
    int                 zorder;
    int                 groupid[ENCOUNT_GROUPMAXNUM];       /* ¥°¥ë¡¼¥×No */
    int                 createprob[ENCOUNT_GROUPMAXNUM];    /* ¤½¤Î¥°¥ë¡¼¥×¤Î½Ð¸½Î¨ */
    RECT                rect;
}ENCOUNT_Table;
...
/*------------------------------------------------------------
 * »ØÄê¤µ¤ì¤¿ºÂÉ¸¤ÎENCOUNT_table¤ÎÅº»ú¤òÄ´¤Ù¤ë¡£
 * zorder¤Î¿ô»ú¤ò¸«¤ÆÍ¥Àè½ç°Ì¤Î¹â¤¤Êª¤ò¼èÆÀ¤¹¤ë¡£
 * °ú¿ô
 *  floor       int     ¥Õ¥í¥¢ID
 *  x           int     xºÂÉ¸
 *  y           int     yºÂÉ¸
...
/*------------------------------------------------------------
 * »ØÄê¤µ¤ì¤¿ºÂÉ¸¤ÎÅ¨À¸À®MAX¿ô¤òÄ´¤Ù¤ë¡£
 * °ú¿ô
 *  floor       int     ¥Õ¥í¥¢ID
 *  x           int     xºÂÉ¸
 *  y           int     yºÂÉ¸
...
/*------------------------------------------------------------
 * »ØÄê¤µ¤ì¤¿ºÂÉ¸¤Î¥¨¥ó¥«¥¦¥ó¥È¥Õ¥£¡¼¥ë¥É¤Îindex¤òÄ´¤Ù¤ë¡£
 * °ú¿ô
 *  floor       int     ¥Õ¥í¥¢ID
 *  x           int     xºÂÉ¸
 *  y           int     yºÂÉ¸
