 ...
 * 湧脰颶�砦璊峊薔坏疇�
 *
 * 湧脰颶�砦璊炾妦慾峊掍屆憧犍疇�匹瑁引勻化中月
 * number = 窒諦杴井
 * CG_CHR_MAKE_FACE + (number*100) + (﹋縉﹌number * 25) + ( 杴�砦� * 5 ) + 軾�砦�
 *
 ------------------------------------------------------------*/
...
/*------------------------------------------------------------
 * 隸�鼵吨�脰颶�砦璊咫橦楔楔仆餑��砦璊藫壑諢�
 * 婁醒
 *  basebaseimagenumber     int             葭卞卅月脰颶�砦�
 *  category                ITEM_CATEGORY   失奶氾丞及市氾打伉
 * 忒曰襖
 *  蕙仄中脰颶�砦獢ㄔ言憿慾弇�反﹜-1
 ------------------------------------------------------------*/
...
/*------------------------------------------------------------
 * 贏牁NPC互憤坌及賡渝祭及午五卞﹜贏牁刓卞踏五仇戈及分﹝
 * 公及凶戶及奶件正□白尼奶旦
 * 婁醒
 *  index   int 左□田□匹 撩л仄凶日FALSE 毛井尹允
 *  fl      int 匏譆及樹扷
 *  x       int
 *  y       int
 * NPC及伙□民件井日銀歹木月及分﹝
