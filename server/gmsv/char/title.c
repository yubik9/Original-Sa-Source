...
typedef enum
{
	TITLE_FUNCTYPENONE,     /*  ´Ø¿ôÀ¸À®¤·¤Ê¤¤  */
	TITLE_FUNCTYPEUSERFUNC, /* definefunction ¤ò»È¤Ã¤ÆÌ¾Á°¤òºî¤ë
							 * ´Ø¿ô¤Î°ú¿ô¤Ï
							 *  int     ¥­¥ã¥é¥¤¥ó¥Ç¥Ã¥¯¥¹
							 *  buf     Ì¾Á°¤Ø¤Î¥Ð¥Ã¥Õ¥¡
							 *  buflen  ¤½¤Î¥Ð¥Ã¥Õ¥¡¤ÎÄ¹¤µ
...
{
	int                 index;      /* µì¥Ç¡¼¥¿¤È¸ß´¹¤ò¼è¤ë¤¿¤á¡£
									 * ¤³¤ÎÈÖ¹æ¤Ç¤â¤Ã¤Æaddtitle¤È¤«¤ä¤ë 
									 */
	char               name[32];
...
typedef struct tagTITLE_configTable
{
	...
	int     param[20][TITLE_PARAMSIZE];              /* É¾²ÁÃÍ */
	int     compareflg[20];         /* ><=Åù¤É¤¦¤¹¤ë¤« */
	int     title;
	BOOL    equipcheckflg;          /* 
									 *  ¥¢¥¤¥Æ¥à°ÜÆ°¥¤¥Ù¥ó¥È¤Ç¤Ï¤³¤Î¥Õ¥é¥°¤ÎÎ©¤Ã¤Æ¤¤¤ë
									 *  ¤â¤Î¤·¤«¸¡º÷¤·¤Ê¤¤¡£
									 */
}TITLE_CONFIGTABLE;
...
/*------------------------------------------------------------
 * indexÈÖ¹æ¤«¤éTITLE_table¤ÎÅº»ú¤òÆÀ¤ë
 ------------------------------------------------------------*/
...
/*  ¥¯¥é¥¤¥¢¥ó¥È¤Ë¸«¤»¤ë¥¹¥­¥ë¥Ç¡¼¥¿¤ÎÊ¸»úÎó¤Î¥Ð¥Ã¥Õ¥¡    */
static char    TITLE_statusStringBuffer[TITLESTRINGBUFSIZ];
/*------------------------------------------------------------
 * ¥¯¥é¥¤¥¢¥ó¥È¤Ë¸«¤»¤ë¾Î¹æ¤ÎÊ¸»úÎó¤òºî¤ë
 * °ú¿ô
 *  title       Title*      ¥¹¥­¥ë
 *  charaindex  int         ¤³¤Î¾Î¹æ¤ò»ý¤Ã¤Æ¤¤¤ë¥­¥ã¥é¤Î¥¤¥ó¥Ç¥Ã¥¯¥¹
 * ÊÖ¤êÃÍ
 *  char*
 ------------------------------------------------------------*/
...
/*------------------------------------------------------------
 * »ØÄê¤µ¤ì¤¿ÈÖ¹æ¤Î¾Î¹æ¤òÄÉ²Ã¤¹¤ë¡£½Å¤µ¤Ê¤Ã¤Æ¤¤¤¿¤é¡¢ÄÉ²Ã¤·¤Ê¤¤
 * °ú¿ô
...
/*------------------------------------------------------------
 * »ØÄê¤µ¤ì¤¿ÈÖ¹æ¤Î¾Î¹æ¤¬¤¢¤Ã¤¿¤éºï½ü¤¹¤ë¡£¤Ê¤«¤Ã¤¿¤é²¿¤â¤·¤Ê¤¤¡£
 * Ê£¿ô¸Ä¤¢¤Ã¤¿¤éÁ´Éô¾Ã¤¹¡£
 * °ú¿ô
 *  charaindex      int     ¥­¥ã¥é¥¤¥ó¥Ç¥Ã¥¯¥¹
 *  titleindex      int     ¾Î¹æ¥¤¥ó¥Ç¥Ã¥¯¥¹
...
/*------------------------------------------------------------
 * Ê£¿ô¹ÔÀßÄê¤ò¤Þ¤È¤á¤Æ£±¹Ô¤Ë¤·¤Æ¤ä¤ë¡£ÆÉ¤à¤Î¤â¤³¤³¤Ç¤¹¤ë¡£
 *------------------------------------------------------------*/
static int TITLE_getConfigOneLine( FILE *fp, char *line, int linelen)
{
	...
	while( fgets( buf, sizeof( buf ), fp )){
		...
		if( buf[0] == '{' ) {
			...
			/* Í­¸ú¹Ô¤À¤¬"{"¤Ç¤Ï¤¸¤Þ¤Ã¤Æ¤Ê¤¤¾ì¹ç¤Ï¤½¤Î¤Þ¤Þ£±¹Ô¤ÇÊÖ¤¹ }*/
			else {
				chompex( buf );
				strcatsafe( line,linelen,  buf);
				return 1;
			...
			if( strncmp( "TITLE", token, 5) == 0 ) {
				...
				for( j = 0; j < arraysizeof( TITLE_param); j ++ ) {
						...
						== 0 )
					{
						...
						/* ÁõÈ÷¥¤¥Ù¥ó¥È¤Ç¾Î¹æ¤ò¥Á¥§¥Ã¥¯¤¹¤ë¥Õ¥é¥°¤òÎ©¤Æ¤ë¡£ */
						if( j == 0 || j == 1 || j == 2) {
...
/*------------------------------------------------------------
 * ¾Î¹æÀßÄê¤Ë¹ç¤¦¤«Ä´¤Ù¤Æ¾Î¹æ¤òÍ¿¤¨¤ë¡£
 * °ú¿ô
 *  charaindex        int   ¥­¥ã¥é¥¤¥ó¥Ç¥Ã¥¯¥¹
 *  mode              BOOL  TRUE:item=¤Î¤â¤Î¤Î¤ßÄ´¤Ù¤ë FALSE:Á´Éô
 * ÊÖ¤êÃÍ
 *  TRUE: ¾Î¹æ¤ËÊÑ²½Í­¤ê¡£
 *  FALSE:²¿¤âÌµ¤«¤Ã¤¿¡£
 *------------------------------------------------------------*/
	...
	/* ½é´ü²½ */
{
	...
	*delcnt = 0;
	...
	for( i = 0; i < TITLE_titlecfgnum; i ++ ) {
		...
		/* Ê£¿ô¾ò·ï¤ËÆ±¤¸¾Î¹æ¤¬³ä¤êÅö¤Æ¤é¤ì¤Æ¤¤¤ë»þ¤Î°Ù¤Ë¡¤
...
/* --------------------------------------
 * »ØÄê¤µ¤ì¤¿data¤È»ý¤Ã¤Æ¤¤¤ë¥¢¥¤¥Æ¥à¤òÈæ³Ó¤¹¤ë¡£
 * -------------------------------------*/
			...
			if( ITEM_CHECKINDEX(itemindex) ) {
				switch( flg) {
				  ...
				  case 5:       /* "=" */
					...
					break;
				  /* ¤³¤ì¤À¤±ÆÃÊÌ°·¤¤¡£
				   * ¥¢¥¤¥Æ¥àÁ´Éô¤ò¸«¤Æ¤½¤ì¤ò»ý¤Ã¤Æ¤¤¤Ê¤«¤Ã¤¿¤é¿¿¤È¤¹¤ë¡£
				   * ¤³¤³¤Ç¤Ï»ý¤Ã¤Æ¤¤¤ë»ö¤òµ¶¤È¤·¤Æ¥Á¥§¥Ã¥¯
				   */
				  case 2:       /* "<>" */
