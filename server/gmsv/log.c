...
/*
 *
 * 伕弘白央奶伙及潘挀反append 允月手及午仄卅中手及互丐月﹝
 * append允月手及反瘉賡卞白央奶伙毛夫日中化云仁﹝
...
/*------------------------------------------------------------
 * 伕弘澀爛白央奶伙毛づ氏匹 file 毛釩仁
 * 婁醒
 *  filename        char*       伕弘澀爛白央奶伙抩
 * 忒曰襖
 *  FALSE   反褐釐卅撩л匹丐月﹝
 ------------------------------------------------------------*/
