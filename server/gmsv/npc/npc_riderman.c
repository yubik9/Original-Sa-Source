...
struct	{
	...
	int		battle;
	int		gotowin;
}buttonproc[13];		/* ok,cancel, yes,no,prev,next 及凜及質咥 */
...
/* 
 * 澀爛白央奶伙毛づ氏匹隙爛今木凶windowno及犯□正毛本永玄允月
 * 
 * 婁醒“
 *		meindex		int		仇及NPC及charaindex
 *		windowno	int		它奴件玉它�砦�
 *		
 */
static BOOL NPC_Riderman_readData( int meindex, int windowno, BOOL chkflg)
{
