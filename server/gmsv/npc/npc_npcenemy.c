...
enum {
	CHAR_WORK_ENCOUNTTYPE	= CHAR_NPCWORKINT1,	/* 巨件市它件玄及酷杅 */
	CHAR_WORK_DIEACT		= CHAR_NPCWORKINT2,	/* 韶氏分凜升丹允月井 */
	CHAR_WORK_WARP_FLOOR	= CHAR_NPCWORKINT3,	/* 伐□皿允月白伕失*/
	CHAR_WORK_WARP_X		= CHAR_NPCWORKINT4,	/* 伐□皿允月X */
	CHAR_WORK_WARP_Y		= CHAR_NPCWORKINT5,	/* 伐□皿允月Y */
	CHAR_WORK_ONEBATTLE 	= CHAR_NPCWORKINT6,	/* 域勾仄井爵お仄卅中 */
	NPC_TIME_MODE			= CHAR_NPCWORKINT7, 
	CHAR_WORK_BASEIMGBAK	= CHAR_NPCWORKINT8, /* 手午及脰颶�砦� */
