...
/*
 *
 *  挃曰卞玉失互丐月午五卞公及玉失毛窒日井及橢瘀卞方勻化釩仁NPC.
 *  玉失及午卅曰卞create允月分仃匹﹜公及玉失毛醜綜今六月仇午互匹五月﹝
 *  反卅仄井仃日木凶午五卞蟈平乓仿毛腹綢仄化﹜引歹曰8穴旦卞玉失互中月
 *  樺寧反公及允屯化卞覆仄化排黍允月﹝孔凶勾及玉失互き凜卞釩仁仇午卞卅月﹝
 *
 *  奶件正□白尼奶旦反Talk匹
 *
 * 玉失毛釩仁凶戶卞
 *
 * 1 云嗯毛藹璋允月﹝藹璋匹五凶日夫日仁     gold|100
 * 2 失奶氾丞毛1蜊藹璋允月 ﹝藹璋匹五凶日夫日仁  item|45
 * 3 失奶氾丞毛儅勻化中月井升丹井譬屯月﹝ 儅勻化中凶日釩仁﹝itemhave|44
 * 4 失奶氾丞毛儅勻化中卅中井升丹井譬屯月﹝儅勻化中卅井勻凶日釩仁﹝
 *          itemnothave|333
 * 5 憊寞毛手勻化中月井升丹井譬屯月﹝儅勻化中凶日釩仁﹝ titlehave|string
 * 6 憊寞毛手勻化中卅中井升丹井譬屯月﹝儅勻化中卅井勻凶日釩仁﹝
 *      titlenothave|string
 *
 * 井卅日內撙杽卞蠶尹月午釩仁﹝嗯及樺寧反﹜
 ...
 * 中凶分五引仄凶﹝＝午蛻歹木月﹝
 *
 * 失奶氾丞藹璋及樺寧反﹜＞窒★毛域蜊中凶分五引允互中中匹允井〝＝午五仁﹝
 ...
 *
 *1  玉失毛化五午丹卞譆仁
 *2  仇及NPC毛贗癲卞玉失及午卅曰卞譆仁﹝婁醒毛 gold|100 卞允月
...
BOOL NPC_DoormanInit( int meindex )
{
    ...
    CHAR_setFlg( meindex , CHAR_ISATTACKED , 0 );  /* 僎猾今木卅中方氏 */
